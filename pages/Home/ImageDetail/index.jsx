...
const ImageDetail = () => {
  ...
  return (
    <Layout>
      <Head>
        <title>{item.describe}</title>
        <meta name="keywords" content={item.describe} />
        <meta name="description" content={item.describe} />
      </Head>
          ...
          <Col span={windowWidth > 500 ? 12 : 24} offset={windowWidth > 500 ? 6 : 0}>
            <Image
              ...
              placeholder={
                <Image
                  preview={false}
                  src={'https://www.dlsjf.top/' + item.name+'-123'}
                  width={'100%'}
                />
              }
            ...
            />
            <div className={style.apron} style={{ minHeight: '35vh' }}>
